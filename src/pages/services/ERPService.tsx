...
const benefits = [
  "End-to-end ERP implementation and configuration",
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center animate-fade-up">
            ...
            <p className="text-lg md:text-xl text-muted leading-relaxed mb-8 max-w-3xl mx-auto">
              Vimico brings expertise in implementing ERP systems for retail and enterprises, helping businesses streamline operations, manage inventory, and optimize their entire value chain.
            </p>
            <Link to="/contact">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-up">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ERP implementation is one of the most impactful investments a business can make – but only when done right. Vimico has deep expertise in implementing ERP solutions that actually deliver on their promise of unified operations and improved efficiency.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                Whether you're a retail business needing inventory and POS integration, or a manufacturing company seeking supply chain optimization, Vimico tailors ERP implementations to your specific industry needs and growth trajectory.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  { icon: Building, title: "Enterprise", desc: "Full integration" },
                  { icon: Layers, title: "Modular Approach", desc: "Scale as you grow" },
                ].map((item) => (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 animate-fade-up delay-200">
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Vimico's ERP implementation service helps businesses of all sizes unify their operations, reduce manual work, and gain real-time visibility across their entire organization.
              </p>
